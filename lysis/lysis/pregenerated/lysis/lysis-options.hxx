...
#ifndef LYSIS_LYSIS_OPTIONS_HXX
#define LYSIS_LYSIS_OPTIONS_HXX
...
namespace lysis
{
  class options
  {
    ...
    print_usage (::std::ostream&,
                 ::lysis::cli::usage_para = ::lysis::cli::usage_para::none);

    // Implementation details.
    //
    protected:
    bool
    _parse (const char*, ::lysis::cli::scanner&);

    private:
    bool
    _parse (::lysis::cli::scanner&,
            ::lysis::cli::unknown_mode option,
            ::lysis::cli::unknown_mode argument);
...
#include <lysis/lysis-options.ixx>
